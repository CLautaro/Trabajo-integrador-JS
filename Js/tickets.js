function calcularTotal() {
    ...
    /*Mensaje de alerta si no se ingresa cantidad de entradas*/

    if (cantEntradas > 0 && !isNaN(cantEntradas) && cantEntradas % 1 == 0) {

      //Se calcula el monto de cada variable
      ...
      window.alert('Debe ingresar la cantidad de entradas en numeros');
    }
  }
